                    ...
                    <div class="panel-body">
                        <form action="/videos/{{ $video->uid }}" method="post" class="videoDetailsEdit">
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" name="allow_votes" id="allow_votes" {{  $video->votesAllowed() ? 'checked="checked' : '' }} > Allow Votes </label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" name="allow_comments" id="allow_comments" {{  $video->votesComments() ? 'checked="checked' : '' }} > Allow Comments  </label>
