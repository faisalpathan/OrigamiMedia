...
class VideoViewController extends Controller
{
    ...
    public function create(Request $request, Video $video)
    {
    	...
    	//grab last view for the user
    	//check if in buffer 
    	//if not in buffer make a view else no view counted
    	if($request->user()) 
    	{
    	...
    	//get last view for the current ip address
    	//and to the same as in the above
    	//here this is created to know that the use which are not registered for taking their view count
